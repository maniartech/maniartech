...
- **It powers live client sites.** [chemotestlaboratory.com](https://chemotestlaboratory.com), the public site of a 35-year, NABL-accredited testing laboratory, is built on Taj Mahal — its footer reads **"Powered by ManiarTech."**

Across our own and client work, Taj Mahal is in production on multiple live sites - including this one and a client laboratory's public site. That makes "production-proven" an honest statement rather than an aspiration.

## Status & how to see it

Taj Mahal SSG is **internal**. It is used in production on multiple of our own and client sites, and an **open-source release is planned**. We are naming it here plainly rather than pointing to a repository, because the code isn't public yet.
